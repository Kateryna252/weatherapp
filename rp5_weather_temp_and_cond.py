...
RP5_CONTAINER_COND_TEG = '<div class="ArchiveInfo">'
RP5_COND_TAG = '<span class="t_1" style="display: none;">+29 °F</span>,'
rp5_cond_tag = rp5_content.find(RP5_COND_TAG, rp5_content.find(RP5_CONTAINER_COND_TEG))
rp5_cond_tag_size = len(RP5_COND_TAG)
rp5_cond_value_start = rp5_cond_tag + rp5_cond_tag_size
rp5_cond = ''
for char in rp5_content[rp5_cond_value_start:]:
    if char != '<':
        rp5_cond += char
    else:
        break
...
print(f'Condition of weather from RP5_site: {rp5_cond}\n')
